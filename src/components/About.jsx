function About() {
  return (
    <section
      id="about"
      className="py-16 md:py-18 px-6 md:px-12 lg:px-24 bg-gray-50"
    >
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col space-y-6">
            <p className="text-base  text-gray-500 leading-relaxed">
              Experienced in integrating educational technology and delivering
              dynamic instruction. Skilled in student engagement, lesson
              development, and classroom innovation to support productive and
              inclusive learning.
            </p>

            <p className="text-base text-gray-500 leading-relaxed">
              I enjoy empowering learners to explore new ideas and develop
              essential skills for the future. With expertise in modern teaching
              tools and personalized learning strategies, I help students grow
              academically and build real-world competencies.
            </p>

            {/* CV Download Button */}
            <div className="pt-4">
              <a href="/cv/LINET WAVINYA CV 2026JAN.pdf" download>
